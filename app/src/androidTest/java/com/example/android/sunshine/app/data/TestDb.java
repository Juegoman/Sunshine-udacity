...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("locationRowID is -1", locationRowID != -1);
        ...
        // query if you like)
        //TestUtilities.validateCurrentRecord("Error: values do not match", c, northPole);
    ...
    public void testWeatherTable() {
        ...
        SQLiteDatabase db = new WeatherDbHelper(
                this.mContext).getWritableDatabase();
        long locationRowId = insertLocation(db);
        assertTrue("locationRowId == -1", locationRowId != -1);
        ...
        TestUtilities.validateCurrentRecord("Error: values do not match", c, weatherValues);
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        locationRowID = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, northPole);
